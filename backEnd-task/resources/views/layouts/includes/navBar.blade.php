    ...
    <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click"
                ...
                <img src="{{ auth()->user()->imagePath }}" alt="user" />
            </div>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            <img alt="Logo" src="{{ auth()->user()->imagePath }}" />
                        </div>
                        <!--end::Avatar-->
                        <!--begin::Username-->
                ...
                <div class="menu-item px-5">
                    <form id="logout-form-store" action="{{ route('logout') }}" method="POST"
                        style="display: none;">
                        @csrf
                    </form>
                    <a class="menu-link px-5" href="javascript:{}"
                        onclick="document.getElementById('logout-form-store').submit(); return false;">
                        @lang('Sign Out')</a>
                </div>
                <!--end::Menu item-->
            </div>
