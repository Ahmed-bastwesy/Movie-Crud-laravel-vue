...
>
    ...
    <!-- BEGIN: Body-->
    <body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="blank-page" style="background-image: linear-gradient(to bottom, #837dcc , rgb(53, 39, 39))">
        <!-- BEGIN: Content-->
                ...
                <div class="content-body">
                    <div class="auth-wrapper auth-v1 px-2">
                        <div class="auth-inner py-2">
                            ...
                            <div class="card mb-0">
                                <div class="card-body">
                                    <h4 class="card-title mb-1">@lang("Welcome to Dashboard!") 👋</h4>
